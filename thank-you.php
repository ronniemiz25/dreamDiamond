...
<body id="main">
    ...
    <div class="thanku_bg">
        <div class="container text-center">
            <div class="section_title wow zoomIn">
                <img class="img-fluid" src="images/thankyoupic.png">
            </div>
            <a href="https://dreamdiamond.in" class="btn btn-outline-primary" role="button">Back to Home <i class="fa-solid fa-house"></i></a>
        </div>
    </div>
    <!----thankyou----->
